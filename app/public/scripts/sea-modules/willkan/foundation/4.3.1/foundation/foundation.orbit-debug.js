define("willkan/foundation/4.3.1/foundation/foundation.orbit-debug", [ "willkan/foundation/4.3.1/foundation/foundation-debug", "$-debug" ], function(require) {
    ...
    (function($, window, document, undefined) {
        ...
        var Orbit = function(el, settings) {
            ...
            self.init = function() {
                ...
                if (settings.animation === "slide") animate = new SlideAnimation(slides_container);
