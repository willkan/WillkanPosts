define("willkan/foundation/4.3.1/foundation/foundation.joyride-debug", [ "willkan/foundation/4.3.1/foundation/foundation-debug", "$-debug" ], function(require) {
    ...
    (function($, window, document, undefined) {
        ...
        Foundation.libs.joyride = {
            ...
            expose: function() {
                var expose, exposeCover, el, origCSS, origClasses, randId = "expose-" + Math.floor(Math.random() * 1e4);
